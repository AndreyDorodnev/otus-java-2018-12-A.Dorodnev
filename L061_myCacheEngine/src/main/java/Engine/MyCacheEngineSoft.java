...
public class MyCacheEngineSoft<K,V> implements CacheEngine<K,V> {
    ...
    public MyCacheEngineSoft(int maxElements,long lifeTimeMs,long idleTimeMs,boolean isEternal){
